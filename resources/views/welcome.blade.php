                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href=""
                                    class="underline text-gray-900 dark:text-white">Kumpulan Link</a></div>
                        </div>

                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                <a href="ets" target="_blank">ETS</a><br/>
                                <a href="file1" target="_blank">File1</a><br/>
                                <a href="file2" target="_blank">File2</a><br/>
                                <a href="file3" target="_blank">File3</a><br/>
                                <a href="file4" target="_blank">File4</a><br/>
                                <a href="file5" target="_blank">File5</a><br/>
                                <a href="file6" target="_blank">File6</a><br/>
                                <a href="file7" target="_blank">File7</a><br/>
                                <a href="file8" target="_blank">File8</a><br/>
                                <a href="file9" target="_blank">File9</a><br/>
                                <a href="file10" target="_blank">File10</a><br/>
                                <a href="file11" target="_blank">File11</a><br/>
                                <a href="file12" target="_blank">File12</a><br/>
                                <a href="file13" target="_blank">File13</a><br/>
                                <a href="file14" target="_blank">File14</a><br/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="/pegawai"
                                    class="underline text-gray-900 dark:text-white">Pegawai</a></div>
                        </div>

                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                Buka halaman Pegawai pada link di atas!
                            </div>
                        </div>
                    </div>
